    ...
    if (fichier==NULL){
        printf("\n fichier in%cxistant !!!",130);
            ...
            while(!feof(fichier)){
                ...
                fgets(tableau_hosp[i].rep,3,fichier);
            ...
            {   fichier=fopen("Fhospitalisation.txt","wt");
                if (fichier==NULL){
                    ...
                    for(i=0;i<taille_tab;i++){
                        ...
                        fprintf(fichier," %d/%d/%d ",tableau_hosp[i].operation.jour,tableau_hosp[i].operation.mois,tableau_hosp.operation.annee);
